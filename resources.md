# Learn Basuri — Resources

# Resources

      A curated map for absolute beginners. Prefer official sites; this room rewrites ideas in our own words.
      ...
      ## Free web tutors worth opening

      
        
          - Radhe Flutes — step-by-step (hold, blow, swaras, alankars)

          - Radhe Flutes — straw blowing
      ...
      ## Quick terms
          ...
          - **Embouchure** — lip shape and angle on the blowing hole

          - **Sa** — tonic; match the drone

          - **Sargam** — Sa Re Ga Ma Pa Dha Ni

          - **Meend** — glide between notes (later skill)

          - **Basuri / bansuri** — bamboo flute (spelling varies)
      ...
      Lesson structure here is original prose for Sangeet Yatra, informed by the public tutorials linked above. For live teachers and paid courses, follow those sites’ own terms.
