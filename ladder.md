...
3. **Ga** — lift hole 2 → `XOOOOO`  
4. **Ma♯** — lift hole 1 → `000000` (all open)  
5. **Pa** — *stop lifting* · new fingering (bridge)  
6. **Dha → Ni → Sa'** — open from the bottom (if Pa = all-closed overblow) or learn high forks later  
